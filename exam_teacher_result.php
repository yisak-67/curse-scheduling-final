...
$search_query_all=mysqli_query($conn,"select * from schedule where teacher like '%$teacher%' and semester like '%$semester%' and sy like '%$sy%'")or die;
$search_query=mysqli_query($conn,"select * from schedule where teacher like '%$teacher%' and type='Exam'   and semester like '%$semester%' and sy like '%$sy%'");
$search_query2=mysqli_query($conn,"select * from schedule where teacher like '%$teacher%'and type='Exam'   and semester like '%$semester%' and sy like '%$sy%'");
$search_query1=mysqli_query($conn,"select * from schedule where teacher like '%$teacher%' and semester like '%$semester%' and sy like '%$sy%'")or die("no schedule is avaliable");
...
?> 
<div class="teph">
<img src="amu.jpg" width="90" height="80">
</div>
<h2 class='_header'>Exam Schedule</h2>
