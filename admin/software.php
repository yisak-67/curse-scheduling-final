...
<h2><font color="white">software Schedule List</font></h2>
...
<br>
  ...
  <ul>
    ...
    <li  class="active">
      <a href="software.php"><font color="white">software</font></a>
    </li>
    </ul>
</div>
...
<div class="table_background">
		...
		<table  id="demoTable"  class="table table-striped table-bordered table-condensed">
			...
			<tbody>
<?php $result=mysqli_query($conn,"select * from schedule where type='' and CYS like '%software%' order by schedule_id DESC")or die(mysqli_error());
