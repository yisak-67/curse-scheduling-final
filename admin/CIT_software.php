...
<h2><font color="white">Software enginering Schedule List</font></h2>
	<a class="btn btn-primary"  href="CIT_add.php">  <i class="icon-plus-sign icon-large"></i>&nbsp;Add BSIS Schedule</a>
	<hr>
	<div class="pagination">
  <ul>
    <li><a href="user_schedule.php"><font color="white">All</font></a></li>
    <li  class="active">
      <a href="CIT_software.php"><font color="white">Software</font></a>
    </li>
...
<div class="demo_jui">
		<table cellpadding="0" cellspacing="0" border="0" class="display" id="log" class="jtable">
			...
			<tbody>
<?php $result=mysqli_query($conn,"select * from schedule where CYS like '%BSIS%' and type=''")or die(mysqli_error());
...
<tr class="del<?php echo $id ?>">
	...
	<a class="btn btn-info" href="CIT_edit_BSIS.php<?php echo '?id='.$id; ?>"><i class="icon-edit icon-large"></i>&nbsp;Edit</a>&nbsp;
