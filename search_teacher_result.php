...
$search_query_all=mysqli_query($conn,"select * from schedule where teacher like '%$teacher%' and semester like '%$semester%' and sy like '%$sy%'");
$search_query=mysqli_query($conn,"select * from schedule where teacher like '%$teacher%' and type='' and day1='MWF'  and semester like '%$semester%' and sy like '%$sy%'");
$search_query2=mysqli_query($conn,"select * from schedule where teacher like '%$teacher%'and type='' and day1='TTh'  and semester like '%$semester%' and sy like '%$sy%'");
$search_query1=mysqli_query($conn,"select * from schedule where teacher like '%$teacher%' and semester like '%$semester%' and sy like '%$sy%'");
...
?>
    <tr>
	 ...
	 8:30 am
      ...
      <td width="120">
	  <?php 
	  $result=mysqli_query($conn,"select * from schedule where teacher like '%$teacher%' and semester like '%$semester%'")or die(mysqli_error());
	 ...
	 echo $row['room'];
	  ?>
	   ...
	   <td width="120">
	  	  <?php 
	  $result1=mysqli_query($conn,"select * from schedule where teacher like '%$teacher%' and semester like '%$semester%' ")or die(mysqli_error());
