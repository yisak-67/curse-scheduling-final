...
<h2><font color="white">BSIS Schedule List</font></h2>
...
<div class="table_background">
		...
		<table  id="demoTable"  class="table table-striped table-bordered table-condensed">
			...
			<tbody>
<?php $result=mysqli_query($conn,"select * from schedule where type='' and CYS like '%BSIS%' order by schedule_id0 DESC")or die(mysqli_error());
