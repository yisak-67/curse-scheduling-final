...
$search_query=mysqli_query($conn,"select * from schedule where teacher like '%$teacher%' and type='Exam'   and semester like '%$semester%' and sy like '%$sy%'")or die(mysqli_error());
$search_query2=mysqli_query($conn,"select * from schedule where teacher like '%$teacher%'and type='Exam'   and semester like '%$semester%' and sy like '%$sy%'")or die(mysqli_error());
