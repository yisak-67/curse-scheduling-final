...
?>
    <tr>
	 ...
	 echo $row['room'];
	  ?>
	   ...
	   <td width="120">
	  	  <?php 
	  $result1=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Wednesday%' and time='12:30 pm' and time_end='1:30 am' ")or die(mysqli_error());
	  $row1=mysqli_fetch_array($result1);
	 echo $row1['subject'];
	 echo '<br>';
	 echo $row1['teacher']; 
	 ...
	 echo $row1['room'];
	  ?>
	    ...
	    <td width="120">
	  	  <?php 
	  $result1=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Friday%' and time='12:30 pm' and time_end='1:30 am' ")or die(mysqli_error());
	  $row1=mysqli_fetch_array($result1);
	 echo $row1['subject'];
	 echo '<br>';
	 echo $row1['teacher']; 
	 ...
	 echo $row1['room'];
      ...
      <td width="120">
	    	 <?php 
	  $result=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Tuesday%' and time='3:00 pm' and time_end='4:30 pm' ")or die(mysqli_error());
	  $row=mysqli_fetch_array($result);
	 echo $row['subject'];
	 echo '<br>';
	 echo $row['teacher']; 
	 ...
	 echo $row['room'];
      ...
      <td width="120">
	    	 <?php 
	  $result=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Thursday%' and time='3:00 pm' and time_end='4:30 pm' ")or die(mysqli_error());
	  $row=mysqli_fetch_array($result);
	 echo $row['subject'];
	 echo '<br>';
	 echo $row['teacher']; 
 ...
 <td width="120">
	  <?php 
	  $result=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Monday%' and time='1:30 pm' and time_end='2:30 pm' ")or die(mysqli_error());
	  $row=mysqli_fetch_array($result);
	 echo $row['subject'];
	 echo '<br>';
	 echo $row['teacher']; 
	 ...
	 echo $row['room'];
	  ?>
	   ...
	   <td width="120">
	  	  <?php 
	  $result1=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Wednesday%' and time='1:30 pm' and time_end='2:30 pm' ")or die(mysqli_error());
	  $row1=mysqli_fetch_array($result1);
	 echo $row1['subject'];
	 echo '<br>';
	 echo $row1['teacher']; 
	 ...
	 echo $row1['room'];
	  ?>
	    ...
	    <td width="120">
	  	  <?php 
	  $result1=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Friday%' and time='1:30 pm' and time_end='2:30 pm' ")or die(mysqli_error());
	  $row1=mysqli_fetch_array($result1);
	 echo $row1['subject'];
	 echo '<br>';
	 echo $row1['teacher']; 
	 ...
	 echo $row1['room'];
      ...
      <td width="120">
	    	 <?php 
	  $result=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Tuesday%' and time='4:30 pm' and time_end='6:00 pm' ")or die(mysqli_error());
	  $row=mysqli_fetch_array($result);
	 echo $row['subject'];
	 echo '<br>';
	 echo $row['teacher']; 
	 ...
	 echo $row['room'];
      ...
      <td width="120">
	     	 <?php 
	  $result=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Thursday%' and time='4:30 pm' and time_end='6:00 pm' ")or die(mysqli_error());
	  $row=mysqli_fetch_array($result);
	 echo $row['subject'];
	 echo '<br>';
	 echo $row['teacher']; 
 ...
 <td width="120">
	  <?php 
	  $result=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Monday%' and time='2:30 pm' and time_end='3:30 pm' ")or die(mysqli_error());
	  $row=mysqli_fetch_array($result);
	 echo $row['subject'];
	 echo '<br>';
	 echo $row['teacher']; 
	 ...
	 echo $row['room'];
	  ?>
	   ...
	   <td width="120">
	  	  <?php 
	  $result1=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Wednesday%' and time='2:30 pm' and time_end='3:30 pm' ")or die(mysqli_error());
	  $row1=mysqli_fetch_array($result1);
	 echo $row1['subject'];
	 echo '<br>';
	 echo $row1['teacher']; 
	 ...
	 echo $row1['room'];
	  ?>
	    ...
	    <td width="120">
	  	  <?php 
	  $result1=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Friday%' and time='2:30 pm' and time_end='3:30 pm' ")or die(mysqli_error());
	  $row1=mysqli_fetch_array($result1);
	 echo $row1['subject'];
	 echo '<br>';
	 echo $row1['teacher']; 
	 ...
	 echo $row1['room'];
      ...
      <td width="120">
	    	 <?php 
	  $result=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Tuesday%' and time='6:00 pm' and time_end='7:30 pm' ")or die(mysqli_error());
	  $row=mysqli_fetch_array($result);
	 echo $row['subject'];
	 echo '<br>';
	 echo $row['teacher']; 
	 ...
	 echo $row['room'];
      ...
      <td width="120">
	      	 <?php 
	  $result=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Thursday%' and time='6:00 pm' and time_end='7:30 pm' ")or die(mysqli_error());
	  $row=mysqli_fetch_array($result);
	 echo $row['subject'];
	 echo '<br>';
	 echo $row['teacher']; 
 ...
 <td width="120">
	  <?php 
	  $result=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Monday%' and time='3:30 pm' and time_end='4:30 pm' ")or die(mysqli_error());
	  $row=mysqli_fetch_array($result);
	 echo $row['subject'];
	 echo '<br>';
	 echo $row['teacher']; 
	 ...
	 echo $row['room'];
	  ?>
	   ...
	   <td width="120">
	  	  <?php 
	  $result1=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Wednesday%' and time='3:30 pm' and time_end='4:30 pm' ")or die(mysqli_error());
	  $row1=mysqli_fetch_array($result1);
	 echo $row1['subject'];
	 echo '<br>';
	 echo $row1['teacher']; 
	 ...
	 echo $row1['room'];
	  ?>
	    ...
	    <td width="120">
	  	  <?php 
	  $result1=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Friday%' and time='3:30 pm' and time_end='4:30 pm' ")or die(mysqli_error());
	  $row1=mysqli_fetch_array($result1);
	 echo $row1['subject'];
	 echo '<br>';
	 echo $row1['teacher']; 
	 ...
	 echo $row1['room'];
      ...
      <td width="120">
	    	 <?php 
	  $result=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Tuesday%' and time='7:30 pm' and time_end='8:30 pm' ")or die(mysqli_error());
	  $row=mysqli_fetch_array($result);
	 echo $row['subject'];
	 echo '<br>';
	 echo $row['teacher']; 
	 ...
	 echo $row['room'];
      ...
      <td width="120">
	  <?php 
	  $result=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Thursday%' and time='7:30 pm' and time_end='8:30 pm' ")or die(mysqli_error());
	  $row=mysqli_fetch_array($result);
	 echo $row['subject'];
	 echo '<br>';
	 echo $row['teacher']; 
     ...
     <td width="120">
	  <?php 
	  $result=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Monday%' and time='4:30 pm' and time_end='5:30 pm' ")or die(mysqli_error());
	  $row=mysqli_fetch_array($result);
	 echo $row['subject'];
	 echo '<br>';
	 echo $row['teacher']; 
	 ...
	 echo $row['room'];
	  ?>
	   ...
	   <td width="120">
	  	  <?php 
	  $result1=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Wednesday%' and time='4:30 pm' and time_end='5:30 pm' ")or die(mysqli_error());
	  $row1=mysqli_fetch_array($result1);
	 echo $row1['subject'];
	 echo '<br>';
	 echo $row1['teacher']; 
	 ...
	 echo $row1['room'];
	  ?>
	    ...
	    <td width="120">
	  	  <?php 
	  $result1=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Friday%' and time='4:30 pm' and time_end='5:30 pm' ")or die(mysqli_error());
	  $row1=mysqli_fetch_array($result1);
	 echo $row1['subject'];
	 echo '<br>';
	 echo $row1['teacher']; 
   ...
   <td width="120">
	  <?php 
	  $result=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Monday%' and time='5:30 pm' and time_end='6:30 pm' ")or die(mysqli_error());
	  $row=mysqli_fetch_array($result);
	 echo $row['subject'];
	 echo '<br>';
	 echo $row['teacher']; 
	 ...
	 echo $row['room'];
	  ?>
	   ...
	   <td width="120">
	  	  <?php 
	  $result1=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Wednesday%' and time='5:30 pm' and time_end='6:30 pm' ")or die(mysqli_error());
	  $row1=mysqli_fetch_array($result1);
	 echo $row1['subject'];
	 echo '<br>';
	 echo $row1['teacher']; 
	 ...
	 echo $row1['room'];
	  ?>
	    ...
	    <td width="120">
	  	  <?php 
	  $result1=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Friday%' and time='5:30 pm' and time_end='6:30 pm' ")or die(mysqli_error());
	  $row1=mysqli_fetch_array($result1);
	 echo $row1['subject'];
	 echo '<br>';
	 echo $row1['teacher']; 
    ...
    <td width="120">
	  <?php 
	  $result=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Monday%' and time='6:30 pm' and time_end='7:30 pm' ")or die(mysqli_error());
	  $row=mysqli_fetch_array($result);
	 echo $row['subject'];
	 echo '<br>';
	 echo $row['teacher']; 
	 ...
	 echo $row['room'];
	  ?>
	   ...
	   <td width="120">
	  	  <?php 
	  $result1=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Wednesday%' and time='6:30 pm' and time_end='7:30 pm' ")or die(mysqli_error());
	  $row1=mysqli_fetch_array($result1);
	 echo $row1['subject'];
	 echo '<br>';
	 echo $row1['teacher']; 
	 ...
	 echo $row1['room'];
	  ?>
	    ...
	    <td width="120">
	  	  <?php 
	  $result1=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Friday%' and time='6:30 pm' and time_end='7:30 pm' ")or die(mysqli_error());
	  $row1=mysqli_fetch_array($result1);
	 echo $row1['subject'];
	 echo '<br>';
	 echo $row1['teacher']; 
  ...
  <td width="120">
	  <?php 
	  $result=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Monday%' and time='7:30 pm' and time_end='8:30 pm' ")or die(mysqli_error());
	  $row=mysqli_fetch_array($result);
	 echo $row['subject'];
	 echo '<br>';
	 echo $row['teacher']; 
	 ...
	 echo $row['room'];
	  ?>
	   ...
	   <td width="120">
	  	  <?php 
	  $result1=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Wednesday%' and time='7:30 pm' and time_end='8:30 pm' ")or die(mysqli_error());
	  $row1=mysqli_fetch_array($result1);
	 echo $row1['subject'];
	 echo '<br>';
	 echo $row1['teacher']; 
	 ...
	 echo $row1['room'];
	  ?>
	    ...
	    <td width="120">
	  	  <?php 
	  $result1=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Friday%' and time='7:30 pm' and time_end='8:30 pm' ")or die(mysqli_error());
	  $row1=mysqli_fetch_array($result1);
	 echo $row1['subject'];
	 echo '<br>';
	 echo $row1['teacher']; 
...
<form method="post" action="preview1.php" target="_blank">
<input type="hidden" name="CYS" value="<?php echo $CYS; ?>">
