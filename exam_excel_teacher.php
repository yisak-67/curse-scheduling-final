...
/////////////////
	...
	$qryreport = mysqli_query($conn,"SELECT * FROM schedule where teacher='$id_get' and type='Exam'  and semester='$semester' and sy='$sy'") or die(mysqli_error());
	...
	$j=$j+1;
			...
			$room = $reportdisp['room'];
			 ...
			 $qryleader = mysqli_query($conn,"SELECT * FROM schedule WHERE teacher='".$leaderid."' and type='Exam'  and semester='$semester' and sy='$sy'") or die(mysqli_error());
