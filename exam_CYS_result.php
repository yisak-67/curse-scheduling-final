...
$search_query_all=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%'");
$search_query=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and type='Exam'   and semester like '%$semester%' and sy like '%$sy%'");
$search_query2=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%'and type='Exam'   and semester like '%$semester%' and sy like '%$sy%'");
$search_query1=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%'");
...
<hr>
<h3><font color="green"><?php echo $row['CYS'];  ?></font></h3>
