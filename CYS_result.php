...
?>
    <tr>
	 ...
	 8:30 am
      ...
      <td width="120">
	  <?php 
	  $result=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Monday%' and time='7:30 am' and time_end='8:30 am' ");
	 ...
	 echo $row['room'];
	  ?>
	   ...
	   <td width="120">
	  	  <?php 
	  $result1=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Wednesday%' and time='7:30 am' and time_end='8:30 am' ");
